...
#define COIN_GENE_NODE_1 "207.148.67.252:8080"
#define COIN_GENE_NODE_2 "198.13.42.198:8080"

#define POOL_NODE_1 "uncmart.com:3333"
#define POOL_NODE_2 "uncmart.com:5555"
//#define POOL_NODE_3 "uncmart.com:7777"
...
void Settings::load() {
  ...
  defaultPoolList << POOL_NODE_1 << POOL_NODE_2;
  ...
  defaultNodesList << COIN_GENE_NODE_1 << COIN_GENE_NODE_2;   // add default node
...
QString Settings::getCurrentRemoteNode() const {
    ...
    if (m_settings.contains(OPTION_REMOTE_NODE)) {
		...
		remotenode = COIN_GENE_NODE_1;   //default gene node
	}
    return remotenode;
}
